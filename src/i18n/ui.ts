...
const es: typeof en = {
	...
	hero: {
		...
		stance: 'Opiniones firmes, sin perder la calma.',
		hire: 'Contrátame ↗',
		work: 'Ver proyectos',
		cv: 'CV (PDF)',
		portrait: 'Retrato de Aaron con gorra y sudadera, dibujado con puntos blancos. Al pasar el ratón aparece la foto.',
		facts: ['Técnico de infraestructura', 'Desde Madrid', 'Abierto a remoto', 'Español e inglés', 'Proxmox · Linux · Windows Server', 'Todo autoalojado'],
	},
	experience: {
		title: 'Experiencia',
		...
		jobs: [
			{
				...
				did: [
					'Clúster <b>Proxmox</b> de dos nodos montado con hardware que otros ya habían jubilado.',
					'Autoaloja <b>Matrix</b> y <b>Nextcloud</b>; inferencia de LLM en local con una RTX 5070 Ti.',
				],
			},
			{
				when: 'mar–may 2026',
			...
			},
			{
				...
				did: ['El título oficial de lo que ya venía haciendo: sistemas, redes y hardware.'],
			},
		],
	},
	projects: {
	...
	sides: {
		...
		aTitle: 'Conectado desde los seis.',
		origin: [
			...
			{ age: 17, text: 'El homelab. Sigue en marcha.' },
	...
	finale: {
		...
		copy: 'Copiar email',
		copied: 'Copiado',
		selected: 'Seleccionado, pulsa copiar',
		cv: 'CV (PDF)',
	...
	about: {
		...
		chapters: [
			...
			{ age: '17', title: 'El burnout, y después el homelab.', text: 'Entonces llegó el burnout. Un parón en seco. El homelab me devolvió a la vida: un clúster Proxmox montado con hardware que otros habían jubilado, con mi propio Matrix, Nextcloud e IA en local. Arreglar errores reales en máquinas reales, con consecuencias reales, también arregló algo en mí. Por esa época monté servidores en Ibertronica, probando cada uno antes de entregarlo.' },
